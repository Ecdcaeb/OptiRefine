...
public abstract class GuiSlot {
    ...
    protected void bindAmountScrolled() {
        this.amountScrolled = MathHelper.clamp((float)this.amountScrolled, (float)0.0f, (float)this.getMaxScroll());
    }
                ...
                if (this.initialClickY == -1) {
                    ...
                    if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
                        ...
                        if (this.mouseX >= i3 && this.mouseX <= j1) {
                            ...
                            l1 = MathHelper.clamp((int)l1, (int)32, (int)(this.bottom - this.top - 8));
    ...
    protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha) {
        ...
        bufferbuilder.pos((double)(this.left + this.width), (double)endY, 0.0).tex((double)((float)this.width / 32.0f), (double)((float)endY / 32.0f)).color(64, 64, 64, endAlpha).endVertex();
        bufferbuilder.pos((double)(this.left + this.width), (double)startY, 0.0).tex((double)((float)this.width / 32.0f), (double)((float)startY / 32.0f)).color(64, 64, 64, startAlpha).endVertex();
