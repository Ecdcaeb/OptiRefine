...
public class LootTableList {
   ...
   private static ResourceLocation register(String var0) {
      return register(new ResourceLocation("minecraft", ☃));
   }
   ...
   public static boolean test() {
      LootTableManager ☃ = new LootTableManager(null);

      for (ResourceLocation ☃x : READ_ONLY_LOOT_TABLES) {
         if (☃.getLootTableFromLocation(☃x) == LootTable.EMPTY_LOOT_TABLE) {
            return false;
         }
      }
