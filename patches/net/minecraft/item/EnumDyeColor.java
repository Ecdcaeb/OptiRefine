...
public enum EnumDyeColor implements IStringSerializable {
   ...
   private EnumDyeColor(int var3, int var4, String var5, String var6, int var7, TextFormatting var8) {
      this.meta = ☃;
      this.dyeDamage = ☃;
      this.name = ☃;
      this.translationKey = ☃;
      ...
      int ☃x = (☃ & 0xFF00) >> 8;
      int ☃xx = (☃ & 0xFF) >> 0;
      this.colorComponentValues = new float[]{☃ / 255.0F, ☃x / 255.0F, ☃xx / 255.0F};
   }
   ...
   public static EnumDyeColor byDyeDamage(int var0) {
      if (☃ < 0 || ☃ >= DYE_DMG_LOOKUP.length) {
         ☃ = 0;
      }

      return DYE_DMG_LOOKUP[☃];
   }
