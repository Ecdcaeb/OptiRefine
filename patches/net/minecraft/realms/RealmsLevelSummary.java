...
public class RealmsLevelSummary implements Comparable<RealmsLevelSummary> {
   ...
   public int compareTo(WorldSummary var1) {
      return this.levelSummary.compareTo(☃);
   }
   ...
   public int compareTo(RealmsLevelSummary var1) {
      if (this.levelSummary.getLastTimePlayed() < ☃.getLastPlayed()) {
         return 1;
      } else {
         return this.levelSummary.getLastTimePlayed() > ☃.getLastPlayed() ? -1 : this.levelSummary.getFileName().compareTo(☃.getLevelId());
      }
   }
}
