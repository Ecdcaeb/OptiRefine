...
public class RegionRenderCacheBuilder {
   ...
   public BufferBuilder getWorldRendererByLayer(BlockRenderLayer var1) {
      return this.worldRenderers[☃.ordinal()];
   }

   public BufferBuilder getWorldRendererByLayerId(int var1) {
      return this.worldRenderers[☃];
   }
}
