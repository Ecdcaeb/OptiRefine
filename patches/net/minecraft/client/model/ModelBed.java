...
public class ModelBed extends ModelBase {
   ...
   public ModelBed() {
      ...
      this.legs[0].rotateAngleX = (float) (Math.PI / 2);
      this.legs[1].rotateAngleX = (float) (Math.PI / 2);
      this.legs[2].rotateAngleX = (float) (Math.PI / 2);
      this.legs[3].rotateAngleX = (float) (Math.PI / 2);
      this.legs[0].rotateAngleZ = 0.0F;
      this.legs[1].rotateAngleZ = (float) (Math.PI / 2);
      this.legs[2].rotateAngleZ = (float) (Math.PI * 3.0 / 2.0);
   ...
   public void preparePiece(boolean var1) {
      this.headPiece.showModel = ☃;
      this.footPiece.showModel = !☃;
      this.legs[0].showModel = !☃;
      this.legs[1].showModel = ☃;
      this.legs[2].showModel = !☃;
      this.legs[3].showModel = ☃;
   }
}
